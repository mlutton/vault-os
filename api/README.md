...
**Status: pre-1.0, single-operator.** It runs daily against a live vault, has 791
...
| **791 tests** | `pytest`, 60 files, no network, no API spend |
...
```bash
pytest                                   # 791 tests, ~30s, no network

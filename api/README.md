...
**Status: pre-1.0, single-operator.** It runs daily against a live vault, has 850
...
| **850 tests** | `pytest`, 60 files, no network, no API spend |
...
```bash
pytest                                   # 850 tests, ~30s, no network

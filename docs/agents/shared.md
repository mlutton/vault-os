...
A module owns its own endpoints, schemas, migrations, and events; infrastructure is never imported by a module, and a module is never imported by infrastructure (ADR-0022).
